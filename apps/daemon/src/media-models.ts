...
export const MEDIA_PROVIDERS: MediaProvider[] = [
  ...
  { id: 'custom-image', label: 'Custom Image API', hint: 'OpenAI /v1/images/generations or local WebUI (e.g. http://127.0.0.1:7861)', integrated: true, docsUrl: 'https://platform.openai.com/docs/api-reference/images', supportsCustomModel: true, customModelPlaceholder: 'checkpoint.safetensors or my-image-model' },
